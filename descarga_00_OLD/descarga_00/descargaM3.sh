...
do
		for i in `seq 0 3`
		do
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$Fechita/00/6hrly_grib_03/flxf$YY$mes1${DD[t]}${HH[i]}.03.$Fechita2.grb2
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$Fechita/00/6hrly_grib_03/pgbf$YY$mes1${DD[t]}${HH[i]}.03.$Fechita2.grb2
		done
done
...
do
		for i in `seq 0 3`
		do
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$Fechita/00/6hrly_grib_03/flxf$YYNext$mes1${DD[t]}${HH[i]}.03.$Fechita2.grb2
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$Fechita/00/6hrly_grib_03/pgbf$YYNext$mes1${DD[t]}${HH[i]}.03.$Fechita2.grb2
		done
done
