...
do
		for i in `seq 0 3`
		do
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_01/flxf$YY$mes1${DD[t]}${HH[i]}.01.$FECHA2.grb2
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_01/pgbf$YY$mes1${DD[t]}${HH[i]}.01.$FECHA2.grb2
		done
done
...
do
		for i in `seq 0 3`
		do
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_01/flxf$YYNext$mes1${DD[t]}${HH[i]}.01.$FECHA2.grb2
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_01/pgbf$YYNext$mes1${DD[t]}${HH[i]}.01.$FECHA2.grb2
		done
done
...
do
		for i in `seq 0 3`
		do
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_01/flxf$YY$mes2${DD[t]}${HH[i]}.01.$FECHA2.grb2
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_01/pgbf$YY$mes2${DD[t]}${HH[i]}.01.$FECHA2.grb2
		done
done
...
do
		for i in `seq 0 3`
		do
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_01/flxf$YYNext$mes2${DD[t]}${HH[i]}.01.$FECHA2.grb2
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_01/pgbf$YYNext$mes2${DD[t]}${HH[i]}.01.$FECHA2.grb2
		done
done
...
do
		for i in `seq 0 3`
		do
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_01/flxf$YY$mes3${DD[t]}${HH[i]}.01.$FECHA2.grb2
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_01/pgbf$YY$mes3${DD[t]}${HH[i]}.01.$FECHA2.grb2
		done
done
...
do
		for i in `seq 0 3`
		do
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_01/flxf$YYNext$mes3${DD[t]}${HH[i]}.01.$FECHA2.grb2
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_01/pgbf$YYNext$mes3${DD[t]}${HH[i]}.01.$FECHA2.grb2
		done
done
