...
do
		for i in `seq 0 3`
		do
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_02/flxf$YY$mes1${DD[t]}${HH[i]}.02.$FECHA2.grb2
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_02/pgbf$YY$mes1${DD[t]}${HH[i]}.02.$FECHA2.grb2
		done
done
...
do
		for i in `seq 0 3`
		do
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_02/flxf$YYNext$mes1${DD[t]}${HH[i]}.02.$FECHA2.grb2
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_02/pgbf$YYNext$mes1${DD[t]}${HH[i]}.02.$FECHA2.grb2
		done
done
