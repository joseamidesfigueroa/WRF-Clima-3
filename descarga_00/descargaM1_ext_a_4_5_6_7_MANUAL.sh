...
do
		for i in `seq 0 3`
		do
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$Fechita/00/6hrly_grib_01/flxf$YY$mes4${DD[t]}${HH[i]}.01.$Fechita.grb2
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$Fechita/00/6hrly_grib_01/pgbf$YY$mes4${DD[t]}${HH[i]}.01.$Fechita.grb2
		done
done
