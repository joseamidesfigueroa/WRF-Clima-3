...
do
		for i in `seq 0 3`
		do
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_02/flxf$YY${MM[indicaMES_ORIGINAL]}${DD[t]}${HH[i]}.02.$FECHA2.grb2
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_02/pgbf$YY${MM[indicaMES_ORIGINAL]}${DD[t]}${HH[i]}.02.$FECHA2.grb2
#		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_02/ocnf$YY${MM[indicaMES_ORIGINAL]}${DD[t]}${HH[i]}.02.$FECHA2.grb2		
		done
echo Paso un dia
done
...
do
		for i in `seq 0 3`
		do
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_02/flxf$YY${MM[indicaMES]}${DD[t]}${HH[i]}.02.$FECHA2.grb2
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_02/pgbf$YY${MM[indicaMES]}${DD[t]}${HH[i]}.02.$FECHA2.grb2
#		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_02/ocnf$YY${MM[indicaMES]}${DD[t]}${HH[i]}.02.$FECHA2.grb2		
		done
echo Paso un dia
done
echo ===================================================================================================
...
echo Paso al Miembro 03*******************************************************************************
echo ""
echo ""
echo ""
echo TERMINA LA DESCARGA DEL MIEMBRO 2
