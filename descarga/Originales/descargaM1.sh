...
#do
		for i in `seq 0 3`
		do
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_01/flxf$YY${MM[indicaMES]}${DD[t]}${HH[i]}.01.$FECHA2.grb2
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_01/pgbf$YY${MM[indicaMES]}${DD[t]}${HH[i]}.01.$FECHA2.grb2
#		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_01/ocnf$YY${MM[indicaMES]}${DD[t]}${HH[i]}.01.$FECHA2.grb2		
		done
#echo Paso un dia
#done
