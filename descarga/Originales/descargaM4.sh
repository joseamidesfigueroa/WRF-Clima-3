...
#ES LA FECHA EN ESTE CASO DEL CUARTO MES.
indicaMES=$((m))
indicaDIA=$((d-1))
indicaDIA2=30
constante=3
...
do
		for i in `seq 0 3`
		do
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_04/flxf$YY${MM[indicaMES_ORIGINAL]}${DD[t]}${HH[i]}.04.$FECHA2.grb2
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_04/pgbf$YY${MM[indicaMES_ORIGINAL]}${DD[t]}${HH[i]}.04.$FECHA2.grb2
#		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_04/ocnf$YY${MM[indicaMES_ORIGINAL]}${DD[t]}${HH[i]}.04.$FECHA2.grb2
		done
echo Paso un dia
done
...
do
		for i in `seq 0 3`
		do
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_04/flxf$YY${MM[indicaMES]}${DD[t]}${HH[i]}.04.$FECHA2.grb2
		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_04/pgbf$YY${MM[indicaMES]}${DD[t]}${HH[i]}.04.$FECHA2.grb2
#		wget http://nomads.ncep.noaa.gov/pub/data/nccf/com/cfs/prod/cfs/cfs.$FECHA3/12/6hrly_grib_04/ocnf$YY${MM[indicaMES]}${DD[t]}${HH[i]}.04.$FECHA2.grb2		
		done
echo Paso un dia
done
...
echo ""
echo FINITO*******************************************************************************
echo TERMINA LA DESCARGA DEL MIEMBRO 4
