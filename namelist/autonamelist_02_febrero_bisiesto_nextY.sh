...
YYYYend=`date --date='1 year' -u +%Y`
MMend=`date --date='29 days' -u +%m`
DDend=`date --date='29 days' -u +%d`
...
YYYYMMDDend=`date --date='29 days' -u +%Y-%m-%d`
...
cat namelist.wps_02_febrero_bisiesto | sed "s/ start_date = 2016-02-01_00:00:00,/ start_date = '${YYYYend}-02-01_00:00:00',/"g > namelist.wps.today1
cat namelist.wps.today1 | sed "s/ end_date   = 2016-02-29_18:00:00,/ end_date   = '${YYYYend}-02-29_18:00:00',/"g > namelist.wps.final
...
cat namelist.input_02_febrero_bisiesto | sed "s/start_year               = 2016/start_year               = ${YYYYend}/"g > namelist.input.today1
cat namelist.input.today1 | sed "s/end_year                 = 2016/end_year                 = ${YYYYend}/"g > namelist.input.final


#==================================================================================================

#Lee el namelist.ARWpost.master y sustituye con las fechas actuales.
cat namelist.ARWpost_02_febrero_bisiesto | sed "s/ start_date = 2016-02-01_00:00:00/ start_date = ${YYYYend}-02-01_00:00:00/"g > namelist.ARWpost.today1
cat namelist.ARWpost.today1 | sed "s/ end_date   = 2016-02-29_18:00:00/ end_date   = ${YYYYend}-02-29_18:00:00/"g > namelist.ARWpost.final
