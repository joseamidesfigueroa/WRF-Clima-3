...
cat namelist.wps_06_junio | sed "s/ start_date = 2016-06-01_00:00:00,/ start_date = '${YYYYstart}-06-01_00:00:00',/"g > namelist.wps.today1
cat namelist.wps.today1 | sed "s/ end_date   = 2016-06-30_18:00:00,/ end_date   = '${YYYYend}-06-30_18:00:00',/"g > namelist.wps.final
...
cat namelist.input_06_junio | sed "s/start_year               = 2016/start_year               = ${YYYYstart}/"g > namelist.input.today1
...
cat namelist.ARWpost_06_junio | sed "s/ start_date = 2016-06-01_00:00:00/ start_date = ${YYYYstart}-06-01_00:00:00/"g > namelist.ARWpost.today1
cat namelist.ARWpost.today1 | sed "s/ end_date   = 2016-06-30_18:00:00/ end_date   = ${YYYYend}-06-30_18:00:00/"g > namelist.ARWpost.final
