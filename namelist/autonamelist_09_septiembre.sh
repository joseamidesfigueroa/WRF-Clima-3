...
YYYYend=`date --date='30 days' -u +%Y`
MMend=`date --date='30 days' -u +%m`
DDend=`date --date='30 days' -u +%d`
...
YYYYMMDDend=`date --date='30 days' -u +%Y-%m-%d`
...
cat namelist.wps_09_septiembre | sed "s/ start_date = 2016-09-01_00:00:00,/ start_date = '${YYYYstart}-09-01_00:00:00',/"g > namelist.wps.today1
cat namelist.wps.today1 | sed "s/ end_date   = 2016-09-30_18:00:00,/ end_date   = '${YYYYend}-09-30_18:00:00',/"g > namelist.wps.final
...
cat namelist.input_09_septiembre | sed "s/start_year               = 2016/start_year               = ${YYYYstart}/"g > namelist.input.today1
...
cat namelist.ARWpost_09_septiembre | sed "s/ start_date = 2016-09-01_00:00:00/ start_date = ${YYYYstart}-09-01_00:00:00/"g > namelist.ARWpost.today1
cat namelist.ARWpost.today1 | sed "s/ end_date   = 2016-09-30_18:00:00/ end_date   = ${YYYYend}-09-30_18:00:00/"g > namelist.ARWpost.final
