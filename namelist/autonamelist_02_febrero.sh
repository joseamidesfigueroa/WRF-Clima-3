...
cat namelist.wps_02_febrero | sed "s/ start_date = 2016-02-01_00:00:00,/ start_date = '${YYYYstart}-02-01_00:00:00',/"g > namelist.wps.today1
cat namelist.wps.today1 | sed "s/ end_date   = 2016-02-28_18:00:00,/ end_date   = '${YYYYstart}-02-28_18:00:00',/"g > namelist.wps.final
...
cat namelist.input_02_febrero | sed "s/start_year               = 2016/start_year               = ${YYYYstart}/"g > namelist.input.today1
...
cat namelist.ARWpost_02_febrero | sed "s/ start_date = 2016-02-01_00:00:00/ start_date = ${YYYYstart}-02-01_00:00:00/"g > namelist.ARWpost.today1
cat namelist.ARWpost.today1 | sed "s/ end_date   = 2016-02-28_18:00:00/ end_date   = ${YYYYstart}-02-28_18:00:00/"g > namelist.ARWpost.final
