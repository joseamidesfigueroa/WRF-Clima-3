...
cat namelist.wps_01_enero | sed "s/ start_date = 2016-01-01_00:00:00,/ start_date = '${YYYYend}-01-01_00:00:00',/"g > namelist.wps.today1
cat namelist.wps.today1 | sed "s/end_date   = 2016-01-31_18:00:00,/ end_date   = '${YYYYend}-01-31_18:00:00',/"g > namelist.wps.final
...
cat namelist.input_01_enero | sed "s/start_year               = 2016/start_year               = ${YYYYend}/"g > namelist.input.today1
...
cat namelist.ARWpost_01_enero | sed "s/ start_date = 2016-01-01_00:00:00/ start_date = ${YYYYend}-01-01_00:00:00/"g > namelist.ARWpost.today1
cat namelist.ARWpost.today1 | sed "s/ end_date   = 2016-01-31_18:00:00/ end_date   = ${YYYYend}-01-31_21:00:00/"g > namelist.ARWpost.final
