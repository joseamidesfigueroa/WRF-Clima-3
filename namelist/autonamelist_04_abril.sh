...
cat namelist.wps_04_abril | sed "s/ start_date = 2016-04-01_00:00:00,/ start_date = '${YYYYstart}-04-01_00:00:00',/"g > namelist.wps.today1
cat namelist.wps.today1 | sed "s/ end_date   = 2016-04-30_18:00:00,/ end_date   = '${YYYYend}-04-30_18:00:00',/"g > namelist.wps.final
...
cat namelist.input_04_abril | sed "s/start_year               = 2016/start_year               = ${YYYYstart}/"g > namelist.input.today1
...
cat namelist.ARWpost_04_abril | sed "s/ start_date = 2016-04-01_00:00:00/ start_date = ${YYYYstart}-04-01_00:00:00/"g > namelist.ARWpost.today1
cat namelist.ARWpost.today1 | sed "s/ end_date   = 2016-04-30_18:00:00/ end_date   = ${YYYYend}-04-30_18:00:00/"g > namelist.ARWpost.final
