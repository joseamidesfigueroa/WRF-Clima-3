...
cat namelist.wps_07_julio | sed "s/ start_date = 2016-07-01_00:00:00,/ start_date = '${YYYYstart}-07-01_00:00:00',/"g > namelist.wps.today1
cat namelist.wps.today1 | sed "s/ end_date   = 2016-07-31_18:00:00,/ end_date   = '${YYYYend}-07-31_18:00:00',/"g > namelist.wps.final
...
cat namelist.input_07_julio | sed "s/start_year               = 2016/start_year               = ${YYYYstart}/"g > namelist.input.today1
...
cat namelist.ARWpost_07_julio | sed "s/ start_date = 2016-07-01_00:00:00/ start_date = ${YYYYstart}-07-01_00:00:00/"g > namelist.ARWpost.today1
cat namelist.ARWpost.today1 | sed "s/ end_date   = 2016-07-31_18:00:00/ end_date   = ${YYYYend}-07-31_18:00:00/"g > namelist.ARWpost.final
